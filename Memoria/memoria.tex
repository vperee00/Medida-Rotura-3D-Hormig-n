...
\end{center}%
  ...
  {%
    \noindent\Large
    Presentado por \@author{} en Universidad de Burgos --- \@date{}\\
...
% Datos de portada
\title{Aplicación para el análisis de rotura en probetas de hormigón}
\author{\nombre}
\tutor{Pedro Latorre Carmona}
\cotutor{Álvaro Mena Alonso}
\date{\today}
...
\noindent D. \printtutor, profesor del departamento de Ingeniería Informática, área de Lenguajes y Sistemas Informáticos y \printcotutor, del departamento de Ingeniería Civil, área de Mecánica de Medios Continuos y Teoría de Estructuras.
