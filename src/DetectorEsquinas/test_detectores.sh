...
#python detectores_esquinas.py -d fast 400_left_0400.png -t 600 --nonmax -o 400_left_0400_fast.png
#python detectores_esquinas.py -d fast 400_input_vggt.png -t 600 --nonmax -o 400_input_vggt_fast.png
